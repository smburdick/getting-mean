...
exports.invokeRolesPolicies = function() {
  acl.allow([{
    roles: ['admin'],
    allows: [{
      resources: '/api/terms/:termId/departments/:departmentId/courses/:courseId/sections',
      permissions: '*'
    }, {
      resources: '/api/terms/:termId/departments/:departmentId/courses/:courseId/sections/:sectionId',
      permissions: '*'
    }]
  }, {
    roles: ['user'],
